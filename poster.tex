...
\end{minipage}}
\hspace*{-2cm}\includegraphics[width = 10.51cm, height = 8.41cm]{img/logos/logo_UGent_EN_RGB_2400_color.png} \raisebox{0.4\height}{\hspace*{2cm}\includegraphics[width = 7.05cm, height = 4.7cm]{img/logos/logo_tervuren_horizontaal.jpg}}
%\begin{tabular}{cccc}
