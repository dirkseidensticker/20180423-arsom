...
\bigbreak
\includegraphics[width = \linewidth, height = \linewidth]{example-image-a}
\bigbreak
...
\bigbreak
\bigbreak
\includegraphics[width = \linewidth, height = .45\linewidth]{example-image-b}
\bigbreak
...
\bigbreak
\bigbreak
\includegraphics[width = \linewidth, height = .45\linewidth]{example-image-c}
\bigbreak
...
\hspace*{-2cm}\includegraphics[width = 10.51cm, height = 8.41cm]{img/logos/logo_UGent_EN_RGB_2400_color.png}
%\begin{tabular}{cccc}
